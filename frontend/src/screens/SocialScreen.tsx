...
import { View, StyleSheet, TouchableOpacity, ScrollView, TextInput, ActivityIndicator, Alert, Image, SafeAreaView, Modal } from 'react-native';
            ...
            <Card style={styles.friendCardContent} variant="default">
              <View style={styles.friendCardLeft}>
                <View style={[
                  ...
                  {friend.avatarUrl ? (
                    <Image source={{ uri: friend.avatarUrl }} style={styles.avatarSmall} />
                  ) : (
          ...
          <View style={{ marginBottom: 24 }}>
            ...
            {requests.map(req => (
              <Card key={req.id} style={styles.requestCardContent} variant="default">
                <View style={styles.friendCardLeft}>
                  {req.avatarUrl ? (
                    <Image source={{ uri: req.avatarUrl }} style={styles.avatarSmall} />
                  ) : (
                    <View style={styles.avatarPlaceholderSmall}>
                      <Feather name="user" size={16} color={colors.surface} />
                    </View>
          ...
          <View style={styles.logModal}>
            ...
            <ScrollView style={{ marginTop: 16 }} showsVerticalScrollIndicator={false}>
              {selectedFriendLog?.log.photoUrl && (
                <Image source={{ uri: selectedFriendLog.log.photoUrl || undefined }} style={styles.logPhoto} />
              )}
              ...
              {selectedFriendLog?.log.musicTitle && (
                <View style={styles.musicCard}>
                  {selectedFriendLog.log.musicArtwork ? (
                    <Image source={{ uri: selectedFriendLog.log.musicArtwork || undefined }} style={styles.musicArt} />
                  ) : (
